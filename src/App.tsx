...
function App() {
	...
	return (
        ...
        xl:h-[62.75rem] w-full relative px-5 xl:px-0'>
			...
			<div id='section_three' className='parralax h-screen w-full flex text-center items-center
        justify-center relative z-20'>

				<div className='section_three-top-right absolute -top-16 right-10 z-10'>
					<img src={sectionThreeRight} alt='side small' />
				</div>
				<div className='section_three-center-bottom absolute -bottom-16 left-0 right-0 grid place-items-center z-10'>
			...
			<div id='section_four' className='w-full text-center'>
				<div className="section_four-title w-full xl:w-[60rem] mx-auto py-10 xl:py-24">
					<h4 className='font-secondary_Variable font-normal text-[2rem] xl:text-[6rem] text-white w-full
            xl:w-[48rem] mx-auto text-center leading-tight'>
			...
			{/* @section 5 */}
			<div id="section_five" className='font-secondary_Variable font-normal text-[6rem]
        text-white mx-auto text-center leading-tight xl:py-9'>
				...
				<div className='mt-60 px-5 xl:px-0'>
					<div className='w-full xl:w-[80rem] relative mx-auto block xl:flex justify-start items-center'>
						...
						<div className='content-section w-full xl:w-[30rem] ml-10 text-left'>
							<HeadingFourComponent>
								<span className='block xl:ml-28'>High End</span> Retreats
							</HeadingFourComponent>
							<SubHeadingOneComponent>
								<span className='block xl:ml-20 mt-8'>
				...
				<div className='mt-60'>
					<div className='w-full xl:w-[80rem] relative mx-auto block xl:flex justify-start items-center'>
						<div className='content-section w-full xl:w-[30rem] mr-10 text-left'>
							<HeadingFourComponent className="text-right xl:-mr-10 relative z-10">
								COMPANY<span className='block xl:-mr-10'>OFFSITES</span>
							</HeadingFourComponent>
							<SubHeadingOneComponent>
								<span className='block xl:mt-8'>
				...
				<div className='mt-60'>
					<div className='w-full xl:w-[80rem] relative mx-auto block xl:flex justify-start items-center'>
						...
						<div className='content-section xl:w-[30rem] xl:ml-10 text-left relative z-10'>
							...
							<SubHeadingOneComponent>
								<span className='block xl:ml-20 mt-8 text-right leading-8'>
				...
				<div className='my-60'>
					<div className='w-full xl:w-[84rem] relative mx-auto block xl:flex justify-start items-center'>
						<div className='content-section xl:w-[30rem] text-left'>
							<HeadingFourComponent className="text-right relative z-10 xl:-mr-10">
						...
						<div className='section_five-sportMusicExperienceBlock img-section'>
